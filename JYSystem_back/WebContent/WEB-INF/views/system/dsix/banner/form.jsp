    ...
    #filePicker div:nth-child(2){width:100%!important;height:100%!important;}  
		...
		jQuery(function() {
		    ...
		    uploader = WebUploader.create({
		        ...
		        fileSingleSizeLimit: 4 * 1024 * 1024 ,   // 单文件的最大限制2M  
		      //不压缩文件
		   		compress: null,
		   	    duplicate :true 
		    });
...
<div id="auDiv" hidden="true" align="left">
		...
		<input type="hidden" id="savePath" readonly="readonly" name="picurl" >
			<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr >
						<td ><font color="red">*</font>banner标识：</td>
						<td >
						<input type="text" jyValidate="required" style="width:95%;" maxlength="50" name="bannerkey" id="bannerkey"></td>
					</tr>
					<tr>
						<td><font color="red">*</font>排序:</td>
						<td><input type="number" style="width:50%;" jyValidate="required,numrangeth" name="bannerorder" id="bannerorder" min='1' max='99999' maxlength="5" jyValidate="required,numrangeth" onkeyup='this.value=this.value.replace(/\D/g,&apos;&apos;)' >&nbsp;&nbsp;<font color="red">输入任意自然数</font></td>
					</tr>
					<tr>
						<td><font color="red">*</font>广场ID号:</td>
						<td><input type="number" style="width:50%;" jyValidate="required,numrangeth" name="newsid" id="newsid" min='1' max='999999' maxlength="5" jyValidate="required,numrangeth" onkeyup='this.value=this.value.replace(/\D/g,&apos;&apos;)' >&nbsp;&nbsp;<font color="red">输入任意自然数</font></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="width:20%;">banner描述：</td>
						<td >&nbsp;
						<textarea rows="2" cols="10" name="title" style="width:95%;height:100px" multiline="true"></textarea>
					</tr>
			</table>
		</form>
</div>
