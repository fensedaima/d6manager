			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							...
							&nbsp;&nbsp;
							状态:
							<select  data-placeholder="状态" name="lookstate" id="lookstate" class="chosen-select isSelect75">
							<option value="" selected="selected">全部</option>
							<option value="1" >未选择</option>
							<option value="2">已觅约</option>
							<option value="3">已下线</option>
							<option value="4">私下推荐</option>
							</select>	
							<!-- &nbsp;&nbsp;<label>选择日期:</label>
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:18%" class="center hidden-480">昵称</th>
...
<script src="${jypath}/static/js/system/dsix/lookabout/lookabout.js"></script>		
</body>
</html>