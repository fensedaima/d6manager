...
<div id="makesure" hidden="true" align="left">
	<form id="makesureForm" method="POST" onsubmit="return false;" >
		<table id="table_report" class="table table-striped table-bordered table-hover">
		    <tr>
		    	<td style="width:15%;" align="center" rowspan="4"><img id="makesureinnerimg" width="100" nodedelete='false' modal='zoomImg' height="100"/></td> 
				<td style="width:15%;" align="left" colspan="2"><strong>会员编号：<span id="makesureloginName"><span><strong></td> 
				<td style="width:15%;" align="left" colspan="2"><strong>审核状态：<span id="makesurelookmakesure"><span><strong></td>
			</tr>
			<tr>
