			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="widget-main">	
							<input type="text" name="loginName" placeholder="会员编号"   class="input-large">
							&nbsp;&nbsp;<input type="text" name="name" placeholder="会员名称"   class="input-large">	
							&nbsp;&nbsp;<input type="text" name="phone" placeholder="手机号"   class="input-large">
							&nbsp;&nbsp;
							<!-- 账号类别:
							<select  data-placeholder="账号类别" name="onlineflag" id="onlineflag" class="chosen-select isSelect75">
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" width="100%">
						<thead>
							<tr>
								<th style="width:10%" class="center">会员编号</th>
								<th style="width:10%" class="center">手机号</th>
								<th style="width:10%" class="center">昵称</th>
								<th style="width:8%"  class="center ">视频认证</th>
								<th style="width:10%" class="center">城市</th>
								<th style="width:8%"  class="center">等级</th>
								<th style="width:5%" class="center">性别</th>
								<th style="width:10%" class="center"><i class="icon-time bigger-110 hidden-480"></i>注册时间</th>
...
<script src="${jypath}/static/js/system/dsix/user/user.js"></script>		
</body>
</html>