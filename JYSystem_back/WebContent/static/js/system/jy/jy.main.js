...
$(function() {
	...
	JY={Object:{notNull:function(obj) {//判断某对象不为空..返回true 否则 false
		...
		Tags:{//设置按钮用的方法,id 这行的id,pBtn 按钮组
			...
			d6cleanForm:function(formId){$("#"+formId+" input[type$='text']").val("");$("#"+formId+" input[type$='hidden']").val("");$("#"+formId+" input[type$='number']").val("");$("#"+formId+" textarea").val("");},
		...
		Model:{//loading框
			...
			editwithsize:function(id,title,dialogwidth,dialogheigth,savefn,cancelfn){
				$("#"+id).removeClass('hide').dialog({width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;保存","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			checkwithsize:function(id,title,dialogwidth,dialogheigth,savefn,cancelfn){
				$("#"+id).removeClass('hide').dialog({width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,
					title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"查看")+"</h4></div>",title_html:true,
					buttons:[{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",
						click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]})
			},
			editwithsizemakesure:function(id,title,dialogwidth,dialogheigth,savefn,cancelfn){
				$("#"+id).removeClass('hide').dialog(
						{width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,
						 title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",
						 title_html:true,
						 buttons:[
						          {html: "<i class='icon-ok bigger-110'></i>&nbsp;通过","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},
							      {html:"<i class='icon-remove bigger-110'></i>&nbsp;拒绝","class":"btn btn-xs",click:function(){if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			editwithsizeusermakesure:function(id,title,dialogwidth,dialogheigth,cancelfn){
				$("#"+id).removeClass('hide').dialog(
						{width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,
						 title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",
						 title_html:true,
						 buttons:[{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			editwithsizecomments:function(id,title,dialogwidth,dialogheigth,savefn,unsavefn){
				$("#"+id).removeClass('hide').dialog(
						{width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,
						 title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",
						 title_html:true,
						 buttons:[
						          {html: "<i class='icon-ok bigger-110'></i>&nbsp;设置前台显示","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},
							      {html:"<i class='icon-remove bigger-110'></i>&nbsp;禁止前台显示","class":"btn btn-xs",click:function(){if(typeof(unsavefn) == 'function'){unsavefn.call(this);}}}
						          ]});
			},
			editwithsizeselfabout:function(id,title,dialogwidth,dialogheigth,savefn,unsavefn){
				$("#"+id).removeClass('hide').dialog(
						{width:dialogwidth,heigth:dialogheigth,resizable:true,modal:true,
						 title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",
						 title_html:true,
						 buttons:[
						          {html: "<i class='icon-ok bigger-110'></i>&nbsp;审核通过","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},
							      {html:"<i class='icon-remove bigger-110'></i>&nbsp;审核不通过","class":"btn btn-xs",click:function(){if(typeof(unsavefn) == 'function'){unsavefn.call(this);}}}
						          ]});
			},
			//审核
		...
		Date:{//时间格式化(默认),time 时间
			  ...
			  DefaultWithoutHMS:function(time){return JY.Object.notNull(time)?(new Date(time).Format("yyyy-MM-dd")):" ";},
