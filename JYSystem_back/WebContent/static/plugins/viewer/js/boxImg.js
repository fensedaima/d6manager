...
$("img[modal='zoomImg']").each(function () {
	var dxsimgsrc=$(this);
	 ...
	 $(this).on("click", function () {
        //给body添加弹出层的html
		 var bodyattr="<div class=\"mask-layer\">" +
        ...
        if(dxsimgsrc.attr("nodedelete")==true||dxsimgsrc.attr("nodedelete")=="true"){
        	 bodyattr+="<button class=\"mask-delete btn-default-styles\">删除</button>";
        }
        
        bodyattr+="</div><div class=\"mask-layer-imgbox auto-img-center\"></div></div></div>";
        
        $("body").append(bodyattr);
        
        function showImg() {
            $(".mask-layer-imgbox").append("<p><img src=\"\" alt=\"\"></p>");
            $(".mask-layer-imgbox img").prop("src", dxsimgsrc.prop("src")); //给弹出框的Img赋值
