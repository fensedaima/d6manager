...
public class Const {
	public static void main(String[] args) {
		Map<String, String> propConfig = PropertyUtil.getPropertyMap("/Users/morigakumori/Downloads/apache-tomcat-8.0.48/webapps/JYSystem/WEB-INF/classes/spring/dbconfig.properties");
	}
	 ...
	 *数据库配置文件位置
	 */
	//public static final String DB_CONFIG=Tools.class.getClassLoader().getResource("/").getPath()+"spring/dbconfig.properties";
	/**
	 *邮箱配置文件位置
	 */
